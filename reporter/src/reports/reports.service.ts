...
export class ReportsService {
  ...
  async getEventsReport(queries: EventsReport) {
    const end = this.metricsService.reportLatencyHistogram.startTimer({
      report_type: 'events',
    })
    ...
    try {
      ...
      return {
        ...
        byEventType: Object.fromEntries(
          byEventType.map(e => [e.eventType, e._count.eventType]),
        ),
        bySource: Object.fromEntries(
          bySource.map(e => [e.source, e._count.source]),
        ),
      }
    } catch (e) {
