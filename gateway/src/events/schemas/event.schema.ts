...
const facebookUserSchema = z.object({
	...
	name: z.string(),
	age: z.number(),
	gender: z.union([z.literal("male"), z.literal("female"), z.literal("non-binary")]),
	location: z.object({
		country: z.string(),
		city: z.string(),
	}),
...
const facebookEngagementTopSchema = z.object({
	actionTime: z.string(),
	referrer: z.union([z.literal("newsfeed"), z.literal("marketplace"), z.literal("groups")]),
...
const facebookEngagementBottomSchema = z.object({
	...
	browser: z.union([z.literal("Chrome"), z.literal("Firefox"), z.literal("Safari")]),
...
const tiktokEngagementTopSchema = z.object({
	...
	device: z.union([z.literal("Android"), z.literal("iOS"), z.literal("Desktop")]),
	country: z.string(),
	videoId: z.string(),
});
