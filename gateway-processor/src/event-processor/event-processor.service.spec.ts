...
describe('EventProcessorService', () => {
    ...
    beforeEach(async () => {
        prisma = {
            outboxEvent: { findMany: jest.fn(), updateMany: jest.fn(), update: jest.fn() },
            $transaction: jest.fn(),
        } as any;
    ...
    it('should stop polling on destroy and wait for current batch', async () => {
        ...
        service['currentBatchPromise'] = new Promise<void>(res => { resolveBatch = res; });
